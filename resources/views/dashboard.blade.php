      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="{{ url('artikels')}}">Data Artikel</a></li>
              <li><a href="{{ url('galleries')}}">Data Gallery</a></li>
              <li><a href="{{ url('membership')}}">Role Data</a></li>
              <li><a href="{{ url('tags')}}">Data Tags</a></li>
            </ul>
          </li>
          <li class="sub-menu">
                <a href="javascript:;">
                ...
                <ul class="sub">
                  <li><a href="{{ action('ArtikelController@create')}}">Tambah Artikel</a></li>
                <li><a href="{{action('GalleryController@create')}}">Tambah Foto Gallery</a></li>
                <li><a href="{{action('TagController@create')}}">Tambah Tags</a></li>
                </ul>
              </li>
        </ul>
        <!-- sidebar menu end-->
